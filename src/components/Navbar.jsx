    ...
    <div className='flex justify-center w-full items-center fixed top-0 z-50 bg-themeblack/90 border-bottom'>
      <div className='w-[1225px] justify-between items-center py-5 flex'>
        ...
        <div className='flex justify-end items-center gap-2'>
          ...
          <button onClick={() => setConnectModal(true)} className='bg-themeWhite/90 hover:bg-themeWhite tracking-wider transition-all ease-in duration-300 cursor-pointer hover:scale-[1.04] rounded-full px-4 py-2 text-themeblack text-sm font-Pooppins font-semibold'>
            Connect
          </button>
        </div>
...
const WalletConnectModal = ({ setConnectModal }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 bg-opacity-50 z-50">
      <div className="bg-themeblack p-6 rounded-lg shadow-xl w-1/3">
